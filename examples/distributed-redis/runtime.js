/**
 * xcomponent-ai Runtime - Distributed Mode (Redis)
 *
 * This script starts an FSM runtime that connects to Redis and PostgreSQL,
...
async function main() {
  ...
  console.log('[Runtime] Connecting to Redis message broker...');
